...
class YahooOAuth1Test(OAuth1Test):
    ...
    guid_body = {"guid": {"uri": "https://social.yahooapis.com/v1/me/guid", "value": "a-guid"}}
    ...
    @responses.activate
    def test_login(self):
        responses.get("https://social.yahooapis.com/v1/me/guid?format=json", status=200, json=self.guid_body)
        self.do_login()
    ...
    def test_get_user_details(self):
        responses.get(self.user_data_url, status=200, json=self.user_data_body)
